...
const kActionButtonColor = Color(0xff009688);
const kActionButtonHighlightColor = Color(0xff009688);

const kWordButtonColor = Color(0xff009688);
const kTooltipColor = Color(0xff009688);
...
var kFailedAlertStyle = AlertStyle(
  ...
  isOverlayTapDismiss: false,
  animationDuration: Duration(milliseconds: 450),
  backgroundColor: Color(0xff004435),
  alertBorder: RoundedRectangleBorder(
    borderRadius: BorderRadius.circular(10.0),
  ),
  titleStyle: TextStyle(
